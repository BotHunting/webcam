...
<body>
  ...
  <div class="controls">
    ...
    <button id="switchToYoloBtn">🔄 Gunakan YOLOv8</button>
  </div>
  ...
  <script>
    ...
    const switchToYoloBtn = document.getElementById('switchToYoloBtn');
    ...
    // Tombol untuk beralih ke YOLOv8
    switchToYoloBtn.addEventListener('click', () => {
      window.location.href = 'yolo.php'; // Arahkan ke halaman yolo.php
    });
